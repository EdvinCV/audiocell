...
export const GET_AVAILABLE_PRODUCTS_ERROR = "GET_AVAILABLE_PRODUCTS_ERROR";
export const GET_NOT_AVAILABLE_PRODUCTS = "GET_NOT_AVAILABLE_PRODUCTS";
export const GET_NOT_AVAILABLE_PRODUCTS_ERROR = "GET_NOT_AVAILABLE_PRODUCTS_ERROR";
export const OBTENER_LISTADO_STOCK = "GET_STOCK_LIST";
export const CLEAR_STOCK_LIST = "CLEAR_STOCK_LIST";
export const ADD_PRODUCT_STOCK = "ADD_PRODUCT_STOCK";
export const ADD_PRODUCT_STOCK_ERROR = "ADD_PRODUCT_STOCK_ERROR";
...
export const GET_DISPOSITIVOS_ERROR = "GET_DISPOSITIVOS_ERROR";
export const POST_DISPOSITIVO = "POST_DISPOSITIVO";
export const POST_DISPOSITIVO_ERROR = "POST_DISPOSITIVO_ERROR";
